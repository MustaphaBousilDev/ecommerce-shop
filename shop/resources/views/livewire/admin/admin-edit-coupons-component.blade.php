<div>
    ...
    <form action='' wire:submit.prevent="updateCoupon" class='w-full form-add' id='form-add' enctype="multipart/form-data">
        @csrf
        <h3 class='text-center heading-form text-3xl'>Edit Coupon</h3>
            ...
            @error('type') <span style="color:red" class="error">{{ $message }}</span> @enderror
            <div class="w-[80%] mx-auto">
            ...
            @error('value') <span style="color:red" class="error">{{ $message }}</span> @enderror
            <div class="w-[80%] mx-auto">
            ...
            @error('cart_value') <span style="color:red" class="error">{{ $message }}</span> @enderror
