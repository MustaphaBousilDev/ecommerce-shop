<div>
    ...
    <div class='flex:col flex-wrap md:flex-row content__dashboard-statistique rounded-md flex mt-9'>
        <div class='content__chart border border-color-gray-background-light w-[100%] md:w-[65%] overflow-y-scroll rounded-lg shadow-sm'>
            ...
            <div class='product__selling flex justify-start gap-8 md:justify-between items-center p-1 md:p-4'>
                <div class='product--dash flex items-center gap-1 md:gap-3'>
                    <div>
                        ...
                        src='https://ma.jumia.is/unsafe/fit-in/300x300/filters:fill(white)/product/42/450684/1.jpg?9241' 
                        alt='product'/>
                    </div>
                    <div>
                        <div class='flex flex-col'>
                            <div class='flex-col md:flex-row flex items-center  md:gap-2'>
                                <h2 class='text-xs md:text-md'>Product Name</h2>
                            ...
                            <h3 class='text-color-gray-dark text-xs hidden md:flex'>Categories</h3>
                            <h3 class='text-color-gray-dark text-xs hidden md:flex'>Brands</h3>
                        </div>
                    </div>
                </div>
                <div class='price-dash'>
                    <h2 class='text-sm md:text-xl flex  items-center flex-col font-bold'>
                        <span class='text-[#bef264]'>13.000</span>
        ...
        <div class='chart__1 w-[100%] md:w-[32%] '>
            <canvas id="myChart"></canvas>
        </div>
    </div>
    <div class='users_place flex flex-col md:flex-row gap-3'>
        <div class="bar__chart w-[100%] md:w-[48%]">
            <canvas id="bar-chart"></canvas>
        </div>
        <div class="bar__chart_2 w-[100%] md:w-[48%]">
