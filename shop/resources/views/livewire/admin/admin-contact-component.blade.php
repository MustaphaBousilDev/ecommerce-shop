<div>
<h3 class="font-bold text-xl  mx-11">Manage Contact</h3>
<div class="relative w-[90%] mx-auto mt-16  overflow-x-auto  shadow-md sm:rounded-lg">
    <div class="flex items-center justify-between pb-4">
        ...
        <div class="relative">
            <div style='top:50%;transform:translateY(-50%);left:5px' class="absolute flex items-center pl-3">
    ...
    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
        ...
        <tbody>
            ...
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                ...
                <td class="px-6 py-4">
                    <span class="inline-block px-2 rounded-md" style='color:rgb(142, 167, 255);background:rgb(214, 227, 254);'>
                        {{$contact->status}}
                    </span>
                </td>
                <td class="px-6 py-4">
                    <div class='flex gap-2'>
                        <a href="#" class="font-medium  text-blue-600 dark:text-blue-500">
                            <i  style='background:rgb(214, 227, 254);color:rgb(142, 167, 255)' 
                        ...
                        <a href="#" class="font-medium text-blue-600 dark:text-blue-500">
                            <i style='background:rgb(225, 254, 214);color:rgb(142, 255, 168)' 
                             class='bx bxs-send inline-block rounded-full p-2 w-6 h-6 flex items-center
                             justify-center' ></i>
                        </a>
                    </div>
                </td>
